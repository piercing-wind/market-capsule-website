    ...
    return (
        <div className={clsx("px-2 pt-2 pb-4", styles.trandingDiv)}>
            ...
            <div className={clsx(styles.imageDiv)}>
                <Image className={clsx("w-100 h-auto borderRadius8")} src={dataObj?.featuredImage?.url || `/assests/capsule-plus/red-image.png`} alt={dataObj?.featuredImage?.alternativeText || dataObj?.name} width={278} height={146} />
                {
                    dataObj?.capsuleplus && (
